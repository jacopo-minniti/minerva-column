...
| **Transfer Competence Mean (15%)**: The average transfer competence score for all HCs introduced in the course. |

| **Transfer Scope (25%)**: This measures the *breadth* of successful transfer within each cornerstone. |
