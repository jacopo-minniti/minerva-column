...
<div style={{ backgroundColor: '#5a3e54', color: 'white', padding: '2.5rem', borderRadius: '4px', marginTop: '2rem', textAlign: 'center' }}>
  <h2 style={{ color: 'white', margin: 0, fontSize: '1.75rem', fontWeight: 'bold', lineHeight: '1.4' }}>
